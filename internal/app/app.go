...
func New(cfg *config.Config) (*App, error) {
	...
	securityRepo := postgres.NewSecurityRepo(db)
	...
	debtSvc := service.NewDebtService(debtRepo, contactSvc, db)
	...
	savingsSvc := service.NewSavingsService(savingsRepo, transactionSvc, db)
