...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} response.SuccessEnvelope{data=[]dto.BudgetWithStatsResponse}
...
// @Success 201 {object} response.SuccessEnvelope{data=dto.BudgetWithStatsResponse}
